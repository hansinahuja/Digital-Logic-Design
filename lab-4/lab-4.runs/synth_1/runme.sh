...
HD_PWD='/home/2018csb1094/Desktop/lab-4/lab-4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiclk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiclk.tcl
