...
HD_PWD='/home/2018csb1094/Desktop/lab-4/lab-4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiclk.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiclk.tcl -notrace
